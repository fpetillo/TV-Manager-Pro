...
async function load(){
 ...
 document.getElementById("health").innerHTML=`<div class="notice ${health.automation?"good":"warn"}">Automation ${health.automation?"armed":"paused"}</div><div class="health-lines"><div><span>Providers</span><strong>${health.providers}</strong></div><div><span>Database</span><strong>OK</strong></div><div><span>Backups</span><strong>Enabled</strong></div></div>`;
