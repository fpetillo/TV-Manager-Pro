...
class OperatorWorkflowTests(unittest.TestCase):
    def test_version_bumped_to_1740(self):
        self.assertIn((ROOT / "VERSION").read_text(encoding="utf-8").strip(), {"17.4.0", "17.5.0", "17.6.0", "17.6.1", "17.7.0", "17.9.0", "17.9.1", "17.10.0", "17.11.0", "17.12.0", "17.13.0", "17.13.1", "17.13.2", "17.13.3", "17.14.0", "17.15.0", "17.16.0", "17.18.0", "17.20.0", "17.21.0", "17.22.0", "17.23.0", "18.0.0", "18.1.0", "18.2.0", "18.2.1"})
