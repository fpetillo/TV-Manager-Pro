...
names={'_normalize_release_title','_release_prefixes_for_match','_show_match_names','_score_postprocess_show_match','_choose_postprocess_show','scan_postprocess'}
...
c.executescript('CREATE TABLE shows(id,name,location,season_folders); CREATE TABLE scene_mappings(show_id,alias); INSERT INTO shows VALUES(1,"Breaking Bad",NULL,1);')
@contextmanager
def cx(): yield c
...
with tempfile.TemporaryDirectory() as folder:
    ...
    for dry_run in [True,False]:
        r=ns['scan_postprocess'](root_override=folder,dry_run=dry_run)
