...
def test_version_is_18_1_0():
    assert (ROOT / "VERSION").read_text(encoding="utf-8").strip() in {"18.1.0", "18.2.0", "18.2.1", "18.2.2", "18.2.3", "18.2.4", "18.2.6", "18.3.0", "18.3.1", "18.3.2", "18.3.3", "18.4.0", "18.4.1", "18.4.2", "18.4.3"}
