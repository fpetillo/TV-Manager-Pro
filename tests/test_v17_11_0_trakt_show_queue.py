...
def test_version_is_17_11_0():
    assert (ROOT / "VERSION").read_text(encoding="utf-8").strip() in {"17.11.0", "17.12.0", "17.13.0", "17.13.1", "17.13.2", "17.13.3", "17.14.0", "17.15.0", "17.16.0", "17.18.0", "17.20.0", "17.21.0", "17.22.0", "17.23.0"}
